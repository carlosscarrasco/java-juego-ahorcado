...
public class Ahorcado {
    public static void main(String[] args) throws Exception {
        ...
        String palabraSecreta = "tiburon"; palabraSecreta = palabraSecreta.toUpperCase();
        ...
        while (!palabraAcertada && contadorIntentos < maxIntentos) {
            System.out.println("Palabra a adivinar " + String.valueOf(letrasAcertadas));
            ...
            if (!letraCorrecta) {
                contadorIntentos ++;
                System.out.println("¡Letra incorrecta! Te quedan " + (maxIntentos - contadorIntentos) + ".");
            }
